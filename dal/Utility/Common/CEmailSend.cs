...
namespace com.Utility
{
    ...
    {
        private string sfrom = "xxxxxxxxxx";//发件人邮箱地址
        private string sfromer = "xxxxxxxxxx";//发件人名称
        private string stoer = "";//收件人名称
        private string sSMTPHost = "xxxxxxxxxx";//邮件服务器地址如：smtp.sohu.com
        private string sSMTPuser = "xxxxxxxxxx";//发件人邮箱地址
        private string sSMTPpass = "xxxxxxxxxx";//独立密码
        /// <summary>
        /// C#发送邮件函数
        /// </summary>
